...
class CpuMemBwLatencyBenchmarkMlc(MicroBenchmarkWithInvoke):
...
class CpuCopyBwBenchmarkGeneral(MicroBenchmarkWithInvoke):
...
if "x86_64" in platform.machine():
    BenchmarkRegistry.register_benchmark('cpu-memory-bw-latency', CpuMemBwLatencyBenchmarkMlc)
else:
    BenchmarkRegistry.register_benchmark('cpu-memory-bw-latency', CpuMemBwLatencyBenchmarkGeneral)
