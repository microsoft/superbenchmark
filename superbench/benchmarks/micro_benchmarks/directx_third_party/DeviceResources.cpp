...
DeviceResources::DeviceResources(
    ...
    unsigned int flags) noexcept(false) : m_backBufferIndex(0),
                                          m_fenceValues{},
...
void DeviceResources::UpdateColorSpace()
{
    ...
    if (m_swapChain && SUCCEEDED(m_swapChain->CheckColorSpaceSupport(colorSpace, &colorSpaceSupport)) && (colorSpaceSupport & DXGI_SWAP_CHAIN_COLOR_SPACE_SUPPORT_FLAG_PRESENT))
    {
