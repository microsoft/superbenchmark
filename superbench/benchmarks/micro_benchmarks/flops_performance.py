...
class FlopsPerformanceCuda(MicroBenchmarkWithInvoke):
    """The FLOPs performance benchmark class."""
    ...
    def _process_raw_result(self, cmd_idx, raw_output):
        ...
        self._result.add_result(precision, max(flops) if len(flops) > 0 else 0)

        return True


BenchmarkRegistry.register_benchmark('flops-perf', FlopsPerformanceCuda, platform=Platform.CUDA)
