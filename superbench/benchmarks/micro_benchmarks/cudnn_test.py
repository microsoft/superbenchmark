...
class CudnnFunction(MicroBenchmarkWithInvoke):
    """The CudnnFunction overhead benchmark class."""
    ...
    def add_parser_arguments(self):
        ...
        self._parser.add_argument(
            '--config_path',
            type=str,
            default='/opt/superbench/superbench/benchmarks/micro_benchmarks/Cudnn_function/para_info.json',
            required=False,
...
BenchmarkRegistry.register_benchmark('cudnn-functions', CudnnFunction)
