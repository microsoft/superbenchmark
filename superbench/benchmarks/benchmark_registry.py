...
class BenchmarkRegistry:
    ...
    @classmethod
    def register_benchmark(cls, name, class_def,
                           parameters=None, platform=None):
    ...
    def get_benchmark_name(cls, benchmark_context):
        ...
        if not cls._is_benchmark_registered(benchmark_name,
                                            platform):
            benchmark_name = None
    ...
    def check_parameters(cls, benchmark_context):
        ...
        ret = False
        if benchmark_name:
            (benchmark_class, params) = cls._select_benchmark(
                benchmark_name,
                platform)
