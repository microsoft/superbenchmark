...
\section
use the section title of 'Software Library - GEMM Performance (FP16)'
...
\subsection
Roofline Plot
Insert an image for the roofline plot, FP16. the image is saved to the same folder where the report is. the image file name is img/gemm.png, use width=0.8\textwidth to control the width of the fiture.
