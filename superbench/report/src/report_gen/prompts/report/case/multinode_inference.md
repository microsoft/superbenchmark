...
\section
use the section title of 'Multi-Node - CoPilot/GPT-175B Mimic Inference Performance (scale 2/4/8)'
...
1.Read the performance tables of 'Per-layer Latency (ms) and Speedup, CoPilot Mimic' from case part.
...
1.Read the performance tables of 'Per-layer Latency (ms) and Speedup, GPT-175B Mimic' from case part.
