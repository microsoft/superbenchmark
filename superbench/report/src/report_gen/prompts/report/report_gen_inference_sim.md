...
The comparison result is presented using the following metrics:
  ...
  \begin{equation}
       \mathit{Speedup(NCCL/RCCL)} =\frac{\mathit{LayerLatencyNCCL/RCCL}_{\mathit{{baseline}}}}{\mathit{LayerLatencyNCCL/RCCL}_{\mathit{{target}}}}
  \end{equation}
  To evaluate with the default communication library. A value of \textgreater1 indicates {target} performs better.


  \begin{equation}
       \mathit{Speedup(MSCCL)} =\frac{\mathit{LayerLatencyMSCCL}_{\mathit{{baseline}}}}{\mathit{LayerLatencyMSCCL}_{\mathit{{target}}}}
  \end{equation}
