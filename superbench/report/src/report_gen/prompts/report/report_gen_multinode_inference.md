...
CoPilot Mimic mimics the workload of real CoPilot inference service. It helps evaluate how H100 and MI300X perform to run CoPilot inference service.
...
The workload is tested on 2 node for both H100 and MI300X.

knowledge 3
GPT3-175B Mimic workload description:
GPT3-175B Mimic mimics the workload of real GPT3-175B inference service. It helps evaluate how H100 and MI300X perform to run GPT3-175B inference service.
...
The comparison result is presented using the following metrics:
  ...
  To evaluate with the optimized communication library. A value of \textgreater1 indicates {target} performs better.