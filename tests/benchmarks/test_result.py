...
def test_add_raw_data():
    ...
    result = BenchmarkResult('micro', BenchmarkType.MICRO.value)
    ...
    result = BenchmarkResult('model', BenchmarkType.MODEL.value)
...
def test_serialize_deserialize():
    ...
    result = BenchmarkResult('pytorch-bert-base1', BenchmarkType.MICRO.value, run_count=2)
    result.add_result('metric1', 300)
    result.add_result('metric1', 200)
