...
class TCPConnectivityBenchmarkTest(unittest.TestCase):
    ...
    def test_tcp_connectivity(self):
        ...
        assert (isinstance(benchmark.result['api.github.com_time_ms_min'][0], numbers.Number))
        assert (isinstance(benchmark.result['api.github.com_time_ms_max'][0], numbers.Number))
        assert (isinstance(benchmark.result['api.github.com_time_ms_avg'][0], numbers.Number))
        ...
        assert (isinstance(benchmark.result['localhost_time_ms_max'][0], numbers.Number))
        assert (isinstance(benchmark.result['localhost_time_ms_min'][0], numbers.Number))
        assert (isinstance(benchmark.result['localhost_time_ms_avg'][0], numbers.Number))
