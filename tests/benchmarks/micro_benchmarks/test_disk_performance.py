...
"""
        ...
        assert (1 == len(benchmark.result[jobname_prefix + '_read_lat_95.000000']))
        assert (1941504 == benchmark.result[jobname_prefix + '_read_lat_95.000000'][0])
        assert (1 == len(benchmark.result[jobname_prefix + '_read_lat_99.000000']))
        assert (2244608 == benchmark.result[jobname_prefix + '_read_lat_99.000000'][0])
        assert (1 == len(benchmark.result[jobname_prefix + '_read_lat_99.900000']))
        assert (3620864 == benchmark.result[jobname_prefix + '_read_lat_99.900000'][0])

        assert (1 == len(benchmark.result[jobname_prefix + '_write_lat_95.000000']))
        assert (1908736 == benchmark.result[jobname_prefix + '_write_lat_95.000000'][0])
        assert (1 == len(benchmark.result[jobname_prefix + '_write_lat_99.000000']))
        assert (2072576 == benchmark.result[jobname_prefix + '_write_lat_99.000000'][0])
        assert (1 == len(benchmark.result[jobname_prefix + '_write_lat_99.900000']))
        assert (2605056 == benchmark.result[jobname_prefix + '_write_lat_99.900000'][0])
