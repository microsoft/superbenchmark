...
def test_cudnn_functions():
    ...
    context = BenchmarkRegistry.create_benchmark_context(
        'cudnn-functions', parameters='--num_warmup 10 --num_steps 10 --num_in_step 100'
    )
    ...
    assert (benchmark)
    assert (benchmark.name == 'cudnn-functions')
    ...
    config_path = '/opt/superbench/superbench/benchmarks/micro_benchmarks/cudnn_function/para_info.json'
