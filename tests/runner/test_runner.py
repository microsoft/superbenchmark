...
class RunnerTestCase(unittest.TestCase):
    ...
    def test_merge_all_metrics(self):
        ...
        expected = json.loads(
            '{"kernel-launch/overhead_event_0/0": 0.00583, "kernel-launch/overhead_event_1/0": 0.00545, '
            '"kernel-launch/overhead_event_2/0": 0.00581, "kernel-launch/overhead_event_3/0": 0.00572, '
            '"kernel-launch/overhead_event_4/0": 0.00559, "kernel-launch/overhead_event_5/0": 0.00591, '
            '"kernel-launch/overhead_event_6/0": 0.00562, "kernel-launch/overhead_event_7/0": 0.00586, '
            '"kernel-launch/overhead_wall_0/0": 0.01018, "kernel-launch/overhead_wall_1/0": 0.01039, '
            '"kernel-launch/overhead_wall_2/0": 0.01067, "kernel-launch/overhead_wall_3/0": 0.01079, '
            '"kernel-launch/overhead_wall_4/0": 0.00978, "kernel-launch/overhead_wall_5/0": 0.01085, '
            '"kernel-launch/overhead_wall_6/0": 0.01036, "kernel-launch/overhead_wall_7/0": 0.01033, '
            '"resnet_models/pytorch-resnet50/steptime_train_float32/0": 253.75, '
            '"resnet_models/pytorch-resnet50/throughput_train_float32/0": 762.19, '
            '"resnet_models/pytorch-resnet50/steptime_train_float16/0": 200.55, '
            '"resnet_models/pytorch-resnet50/throughput_train_float16/0": 969.58, '
            '"resnet_models/pytorch-resnet101/steptime_train_float32/0": 386.98, '
            '"resnet_models/pytorch-resnet101/throughput_train_float32/0": 498.57, '
            '"resnet_models/pytorch-resnet101/steptime_train_float16/0": 310.31, '
            '"resnet_models/pytorch-resnet101/throughput_train_float16/0": 624.85, '
            '"pytorch-sharding-matmul/allreduce/0": 10.87, "pytorch-sharding-matmul/allreduce/1": 10.69, '
            '"pytorch-sharding-matmul/allgather/0": 10.56, "pytorch-sharding-matmul/allgather/1": 10.16}'
        )
        print(self.runner._SuperBenchRunner__merge_all_metrics(result_summary, reduce_ops))
