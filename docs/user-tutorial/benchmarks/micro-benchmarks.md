...
| tensorrt-inference/gpu_lat_ms_99          | time (ms) | The percentile 99 GPU latency to execute the kernels for a query.                                        |
| tensorrt-inference/host_lat_ms_mean       | time (ms) | The mean H2D, GPU, and D2H latency to execute the kernels for a query.                                   |
| tensorrt-inference/host_lat_ms_99         | time (ms) | The percentile 99 H2D, GPU, and D2H latency to execute the kernels for a query.                          |
