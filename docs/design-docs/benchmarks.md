...
result = {
    ...
    'result': {
            ...
            'throughput-train-fp16': [avg_throughput1, ..., avg_throughputN],
            'throughput-inference-fp32': [avg_throughput1, ..., avg_throughputN],
            'throughput-inference-fp16': [avg_throughput1, ..., avg_throughputN],
    },
    'reduce_op': {
        'throughput-train-fp32': 'min',
        'throughput-train-fp16': 'min',
        'throughput-inference-fp32': None,
        'throughput-inference-fp16': None,
    },
}
```
