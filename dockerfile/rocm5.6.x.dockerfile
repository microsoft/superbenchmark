ARG BASE_IMAGE=rocm/pytorch:rocm5.6_ubuntu20.04_py3.8_pytorch_1.13.1
FROM ${BASE_IMAGE}
...
RUN add-apt-repository universe && \
    apt-get update
RUN make ROCBLAS_BRANCH=release/rocm-rel-5.6 ROCM_VER=rocm-5.5.0 -C third_party rocm -o cpu_hpl -o cpu_stream
