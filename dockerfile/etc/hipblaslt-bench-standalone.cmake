...
#   cmake -S /path/to/hipBLASLt -B /path/to/hipBLASLt/build -DCMAKE_HIP_ARCHITECTURES="gfx942;gfx950"
...
# Mirrors the source list of upstream clients/common/src/CMakeLists.txt with
# rocRoller (mxDataGen.cpp) and BLIS (blis_interface.cpp) disabled.
set(HIPBLASLT_CLIENTS_COMMON_SOURCES
...
add_library(hipblaslt-clients-common STATIC ${HIPBLASLT_CLIENTS_COMMON_SOURCES})
...
set_source_files_properties(${HIPBLASLT_CLIENTS_COMMON_SOURCES} PROPERTIES LANGUAGE HIP)
...
target_include_directories(hipblaslt-clients-common
    PUBLIC
        ...
        "${HIPBLASLT_SRC}/tensilelite/include"
...
# defines.
target_link_directories(hipblaslt-clients-common PUBLIC "${ROCM_PATH}/lib")
