ARG BASE_IMAGE=rocm/pytorch:rocm5.2.3_ubuntu20.04_py3.7_pytorch_1.11.0
FROM ${BASE_IMAGE}
...
# Install latest rccl-rdma-sharp-plugins
RUN cd /opt/rocm && \
...
RUN make ROCBLAS_BRANCH=release/rocm-rel-5.2 -C third_party rocm
